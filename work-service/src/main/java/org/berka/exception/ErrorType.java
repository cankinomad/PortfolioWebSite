...
public enum ErrorType {
    ...
    WORK_NOT_CREATED(4210,"Is olusturulamadi",HttpStatus.BAD_REQUEST),
    ACCOUNT_NOT_ACTIVE(4211,"Aktive Edilmemis hesap. Lutfen hesabinizi aktif hale getirin" ,HttpStatus.FORBIDDEN),
    WORK_NOT_FOUND(4212,"Boyle bir is bulunamadi",HttpStatus.BAD_REQUEST),
    ...
    WORK_ALREADY_EXIST(4115,"bu is zaten mevcut lutfen baska bir isim giriniz" ,HttpStatus.BAD_REQUEST);
